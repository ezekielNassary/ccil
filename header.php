 ...
 <!-- ======= Sidebar ======= -->
  ...
  <li class="nav-item">
        <a class="nav-link collapsed" data-bs-target="#charts-nav" data-bs-toggle="collapse" href="#">
          <i class="bi bi-bar-chart"></i><span>User Options</span><i class="bi bi-chevron-down ms-auto"></i>
        </a>
        <ul id="charts-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
           <li class="production-insert">
            <a href="javascript:void(0)">
              <i class="bi bi-circle"></i><span>Make Production Report </span>
            </a>
          </li>
          <li class="production">
            <a href="javascript:void(0)">
              <i class="bi bi-circle"></i><span>View Production Report</span>
            </a>
          </li>
         <li class="production-monthly">
            <a href="javascript:void(0)">
              <i class="bi bi-circle"></i><span>Monthly Production</span>
            </a>
          </li>
             <li class="production-stock">
            <a href="javascript:void(0)">
              <i class="bi bi-circle"></i><span>Stock</span>
            </a>
          </li>
             <li class="production-plan">
            <a href="javascript:void(0)">
